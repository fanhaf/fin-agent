(ns fin-agent.parsers.pekao-arch
  )

;####################
(defn filter-operation-columns [report] (filter #(= (count %) 7) report))
...
(defn operation-type [trans-src] (nth trans-src 6))

(defn operation-recipient [trans-src] (nth trans-src 1))

(defn operation-description [trans-src] (nth trans-src 3))

(defn operation-amount [trans-src] (nth trans-src 4))
