(ns fin-agent.controllers.pekao-arch
  (:use [compojure.core :only (defroutes GET POST)]
        [clojure.java.io]
        [hiccup.core])
  (:require [fin-agent.parsers.pekao-arch :as pekao]
...
(defn home-page []
    (html [:form {:action "/translator/pekao_arch" :method "post" :enctype "multipart/form-data"}
...
(defroutes routes
           (GET "/translator/pekao_arch" []
                (home-page))
           (POST "/translator/pekao_arch" {params :params}
